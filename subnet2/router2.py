...
def manage_client(client):
    while True:
        try:
            ...
            if text == "join":
                print("client with IP: " + client_ip + " connected to the router 2")
                ...
                print("client with IP: " + client_ip + " disconnected from the router 2")
